...
struct TestStatusBadge: View {
    ...
    private var localizedText: String {
        switch status {
        case .scheduled:
            NSLocalizedString("practice.status.scheduled", comment: "Scheduled")
        case .completed:
            NSLocalizedString("practice.status.completed", comment: "Completed")
        case .missed:
            NSLocalizedString("practice.status.missed", comment: "Missed")
        case .archived:
            NSLocalizedString("practice.status.archived", comment: "Archived")
        }
    }
