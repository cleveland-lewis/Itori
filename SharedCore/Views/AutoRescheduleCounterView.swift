            ...
            Form {
                Section {
                    Text(NSLocalizedString(
                        "autoreschedulecounter.autoreschedule.invariant.counters",
                        value: "Auto-Reschedule Invariant Counters",
                        comment: "Auto-Reschedule Invariant Counters"
                    ))
                    .font(.headline)
                    Text(NSLocalizedString(
                ...
                Section("Invariant Status") {
                    ...
                    if !enabled {
                        let hasViolation = counters.checksExecuted > 0 || counters.sessionsAnalyzed > 0 || counters
