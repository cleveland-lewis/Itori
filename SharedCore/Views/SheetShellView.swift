...
class PrewarmCoordinator {
    ...
    private func prewarmFormatters() async {
        ...
        _ = DateFormatter.iso8601Full
        _ = DateFormatter.shortDate
        _ = DateFormatter.shortTime

        // Prewarm number formatters
        let formatter = NumberFormatter()
        formatter.numberStyle = .decimal
        _ = formatter.string(from: 3.5)
    ...
    private func prewarmViewState(
        coursesStore: CoursesStore,
        assignmentsStore _: AssignmentsStore
    ) async {
