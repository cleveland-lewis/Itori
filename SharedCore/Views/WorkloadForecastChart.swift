    ...
    static var previews: some View {
        let sampleForecast = WorkloadForecast(
            weeklyLoad: [
                ...
                WeekLoad(weekStart: Date().addingTimeInterval(7*24*3600), hours: 22, breakdown: ["homework": 10, "reading": 7, "project": 5]),
                WeekLoad(weekStart: Date().addingTimeInterval(14*24*3600), hours: 18, breakdown: ["exam": 12, "review": 6]),
                WeekLoad(weekStart: Date().addingTimeInterval(21*24*3600), hours: 12, breakdown: ["homework": 7, "reading": 5])
            ],
