        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                SettingRow(
                    icon: "decrease.indent",
                    title: "Reduce Transparency",
                    value: NSWorkspace.shared.accessibilityDisplayShouldReduceTransparency ? "Enabled" : "Disabled",
                    color: .orange
                )
                ...
                SettingRow(
                    icon: "sun.max.fill",
                    title: "Increase Contrast",
                    value: NSWorkspace.shared.accessibilityDisplayShouldIncreaseContrast ? "Enabled" : "Disabled",
                    color: .yellow
                )
                #endif
