...
// MARK: - Dev-Only Debugging
            ...
            VStack(alignment: .trailing, spacing: 4) {
                if isExpanded {
                    VStack(alignment: .leading, spacing: 2) {
                        Text(NSLocalizedString("Interface Preferences", value: "Interface Preferences", comment: ""))
                            .font(.caption.bold())
                        Divider()
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.reduce_motion",
                                value: "Reduce Motion: %@",
                                comment: "Interface preferences debug"
                            ),
                            prefs.reduceMotion ? "✓" : "✗"
                        ))
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.increase_contrast",
                                value: "Increase Contrast: %@",
                                comment: "Interface preferences debug"
                            ),
                            prefs.increaseContrast ? "✓" : "✗"
                        ))
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.reduce_transparency",
                        ...
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.compact_density",
                        ...
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.large_tap_targets",
                                value: "Large Tap Targets: %@",
                                comment: "Interface preferences debug"
                            ),
                            prefs.largeTapTargets ? "✓" : "✗"
                        ))
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.material_intensity",
                                value: "Material Intensity: %.1f",
                                comment: "Interface preferences debug"
                            ),
                            prefs.materialIntensity
                        ))
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.animations",
                                value: "Animations: %@",
                                comment: "Interface preferences debug"
                            ),
                            prefs.animation.enabled ? "✓" : "✗"
                        ))
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.haptics",
                                value: "Haptics: %@",
                                comment: "Interface preferences debug"
                            ),
                        ...
                        Text(String(
                            format: NSLocalizedString(
                                "interface.debug.tooltips",
                                value: "Tooltips: %@",
                                comment: "Interface preferences debug"
                            ),
                            prefs.tooltips.enabled ? "✓" : "✗"
                        ))
                    }
                    .font(.caption2)
                    .padding(8)
    ...
    func assertInterfacePreferencesInjected(
        _ prefs: InterfacePreferences,
