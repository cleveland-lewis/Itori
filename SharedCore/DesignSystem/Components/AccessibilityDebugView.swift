    ...
    struct AccessibilityDebugView: View {
        ...
        private var headerSection: some View {
            VStack(alignment: .leading, spacing: 8) {
                Text(NSLocalizedString(
                    "accessibilitydebug.accessibility.debug.tools",
                    value: "Accessibility Debug Tools",
                    comment: "Accessibility Debug Tools"
                ))
                .font(.largeTitle)
                .fontWeight(.bold)

                Text(NSLocalizedString(
                    "accessibilitydebug.test.and.preview.accessibility.features",
                    value: "Test and preview accessibility features without changing system settings",
                    comment: "Test and preview accessibility features without ch..."
                ))
                .font(.subheadline)
        ...
        private var currentStatusSection: some View {
            VStack(alignment: .leading, spacing: 12) {
                Text(NSLocalizedString(
                    "accessibilitydebug.current.system.settings",
                    value: "Current System Settings",
                    comment: "Current System Settings"
                ))
                .font(.headline)
        ...
        private var simulationSection: some View {
            VStack(alignment: .leading, spacing: 12) {
                Text(NSLocalizedString(
                    "accessibilitydebug.simulate.accessibility.features",
                    value: "Simulate Accessibility Features",
                    comment: "Simulate Accessibility Features"
                ))
                .font(.headline)

                Text(NSLocalizedString(
                    "accessibilitydebug.note.these.simulations.are.for",
                    value: "Note: These simulations are for preview only and don't affect actual system behavior",
                    comment: "Note: These simulations are for preview only and d..."
                ))
                .font(.caption)
                .foregroundStyle(.secondary)
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Toggle(
                        NSLocalizedString(
                            "accessibilitydebug.toggle.reduce.motion",
                            value: "Reduce Motion",
                            comment: "Reduce Motion"
                        ),
                        isOn: $simulateReduceMotion
                    )
                    Toggle(
                        NSLocalizedString(
                            "accessibilitydebug.toggle.reduce.transparency",
                            value: "Reduce Transparency",
                            comment: "Reduce Transparency"
                        ),
                        isOn: $simulateReduceTransparency
                    )
                    Toggle(
                        NSLocalizedString(
                            "accessibilitydebug.toggle.increase.contrast",
                            value: "Increase Contrast",
                            comment: "Increase Contrast"
                        ),
                        isOn: $simulateIncreaseContrast
                    )
                    Toggle(
                        NSLocalizedString(
                            "accessibilitydebug.toggle.differentiate.without.color",
                            value: "Differentiate Without Color",
                            comment: "Differentiate Without Color"
                        ),
                        isOn: $simulateDifferentiateWithoutColor
                    )
                    Toggle(
                        NSLocalizedString(
                            "accessibilitydebug.toggle.voiceover.active",
                            value: "VoiceOver Active",
                            comment: "VoiceOver Active"
                        ),
                        isOn: $simulateVoiceOver
                    )
                }
                .padding(12)
                .background(
        ...
        private var previewSection: some View {
            VStack(alignment: .leading, spacing: 12) {
                Text(NSLocalizedString(
                    "accessibilitydebug.live.preview",
                    value: "Live Preview",
                ...
                VStack(spacing: 16) {
                    ...
                    HStack(spacing: 12) {
                        Button(NSLocalizedString(
                            "accessibilitydebug.button.standard.button",
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text(NSLocalizedString(
                            "accessibilitydebug.sample.card",
                            value: "Sample Card",
                            comment: "Sample Card"
                        ))
                        .font(.headline)
                        Text(NSLocalizedString(
                            "accessibilitydebug.this.card.demonstrates.material.effects",
                            value: "This card demonstrates material effects",
                            comment: "This card demonstrates material effects"
                        ))
                        .font(.caption)
                        .foregroundStyle(.secondary)
                    }
