...
final class MainThreadDebugger: ObservableObject {
    ...
    private func checkMainThread() {
        ...
        DebugLogger
            .log(
                "🟢 [\(timeStr)] [MainThreadDebugger] STATUS: Memory: \(memStr)MB | Blocks: \(blocksStr) | Active Tasks: \(performanceMetrics.activeTasks)"
            )
    }
    ...
    private func recordMainThreadBlock(duration: TimeInterval) {
        ...
        let total = performanceMetrics
            .averageBlockDuration * Double(performanceMetrics.totalMainThreadBlocks - 1) + duration
        ...
        DebugLogger
            .log(
                "🔴 [\(timeStr)] [MainThreadDebugger] MAIN THREAD BLOCKED: \(String(format: "%.2f", duration * 1000))ms"
            )
    ...
    func recordLongOperation(name: String, duration: TimeInterval) {
        ...
        DebugLogger
            .log(
                "🟡 [\(timeStr)] [MainThreadDebugger] LONG OPERATION: \(name) took \(String(format: "%.2f", duration * 1000))ms"
            )
    ...
    func recordTaskCreation(name: String) {
        ...
        DebugLogger
            .log(
                "📦 [\(timeStr)] [MainThreadDebugger] TASK CREATED: \(name) (Active: \(performanceMetrics.activeTasks))"
            )
    }
    ...
    func recordTaskCompletion(name: String, duration: TimeInterval) {
        ...
        DebugLogger
            .log(
                "✅ [\(timeStr)] [MainThreadDebugger] TASK COMPLETED: \(name) in \(String(format: "%.2f", duration * 1000))ms (Active: \(performanceMetrics.activeTasks))"
            )
    }
    ...
    func recordInfo(message: String) {
        ...
        DebugLogger
            .log(
                "ℹ️  Memory: \(String(format: "%.1f", performanceMetrics.memoryUsageMB))MB | Active Tasks: \(performanceMetrics.activeTasks)"
            )
        DebugLogger.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    }
