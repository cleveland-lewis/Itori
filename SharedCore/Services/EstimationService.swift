...
public class EstimationService: ObservableObject {
    ...
    public func estimateTaskDuration(
        ...
        await durationEstimator.estimateDuration(
            category: category,
    ...
    public func getEffortProfile(courseType: String, credits: Int) -> EffortProfile {
        effortProfileEstimator.getEffortProfile(courseType: courseType, credits: credits)
    }
    ...
    public func generateWorkloadForecast(
        ...
        await workloadForecaster.generateForecast(
    ...
    private func fetchCompletionHistory(courseId _: String, category _: String) async -> [CompletionHistory] {
