...
struct EnhancedTextParser {
    ...
    private static func parseAssignmentLine(_ line: String, context: ParsingContext, fingerprint: String) -> ParsedAssignmentItem? {
        let lowercased = line.lowercased()
    ...
    private static func parseEventLine(_ line: String, context: ParsingContext, fingerprint: String) -> ParsedAssessmentEvent? {
        let lowercased = line.lowercased()
