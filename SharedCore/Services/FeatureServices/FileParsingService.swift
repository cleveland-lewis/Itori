...
final class FileParsingService: ObservableObject {
    ...
    private func parseTextContent(_ text: String, fingerprint: String, category: FileCategory) async throws -> ParseResults {
        // Use enhanced NLP parser for better results
        return EnhancedTextParser.parseTextContent(text, fingerprint: fingerprint, category: category)
    }
...
enum ParsingError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .pdfNotSupported:
            return "PDF parsing not supported on this platform"
        }
    }
}
