...
final class LocalLLMService: ObservableObject {
    enum LLMError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case let .contractViolation(reason):
                "LLM cannot comply with requirements: \(reason)"
    ...
    private func generateRationale(
        slot: QuestionSlot,
        topicText: String,
        correctAnswer _: String
    ) -> String {
        let bloomExplanation = switch slot.bloomLevel {
        case .remember:
            "This requires recalling key facts about \(topicText)."
        case .understand:
            "This tests your understanding of how \(topicText) functions."
        case .apply:
            "This assesses your ability to apply \(topicText) concepts."
        case .analyze:
            "This evaluates your analytical thinking about \(topicText)."
        case .evaluate:
            "This measures your ability to evaluate \(topicText) critically."
        case .create:
            "This tests your capacity to synthesize ideas about \(topicText)."
        }
