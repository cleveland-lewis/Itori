...
public final class StudyHoursTracker: ObservableObject {
    ...
    private init() {
        ...
        let folder = dir.appendingPathComponent("ItoriAnalytics", isDirectory: true)
    ...
    public func recordCompletedSession(sessionId: UUID, durationMinutes: Int) {
        ...
        LOG_UI(
            .info,
            "StudyHoursTracker",
            "Recorded session: \(durationMinutes) minutes. Today: \(totals.todayMinutes)m, Week: \(totals.weekMinutes)m"
        )
    }
