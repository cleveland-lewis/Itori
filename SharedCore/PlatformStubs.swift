...
import SwiftUI
        ...
        public extension NSColor {
            ...
            static var alternatingContentBackgroundColors: [NSColor] { [
        ...
        public struct LocalTimerActivity: Identifiable, Hashable {
            ...
            public init(
                ...
                isPinned: Bool = false,
                totalTrackedSeconds: TimeInterval = 0,
                todayTrackedSeconds: TimeInterval = 0
            ) {
                self.id = id
                self.name = name
    ...
    public class SettingsWindowController {
        public static let lastPaneKey = "itori.settings.lastSelectedPane"
        public init(appSettings _: Any, coursesStore _: Any, coordinator _: Any) {}
    ...
    public enum RootTab: String, CaseIterable, Identifiable {
        ...
        public var title: String {
            ...
            case .settings: NSLocalizedString("tab.settings", value: "Settings", comment: "Sidebar tab")
            }
        }
    ...
    public struct CalendarEvent: Identifiable, Hashable {
        ...
        public init(
            ...
            notes: String? = nil,
            url: URL? = nil,
            category: EventCategoryStub? = nil
        ) {
            self.id = id
            self.title = title
            self.startDate = startDate
    ...
    // StoredScheduledSession and StoredOverflowSession are defined in SharedCore/State/PlannerStore.swift; avoid
