            ...
            List {
                Section {
                    Text(NSLocalizedString(
                        "settings.planner.body",
                        value: "Planner configuration settings",
                        comment: "Planner settings body"
                    ))
                    ...
                    Text(NSLocalizedString(
                        "settings.planner.footer",
                        value: "Configure how assignments are automatically scheduled",
                        comment: "Planner footer"
                    ))
                }
