    ...
    struct IOSAppearanceSettingsView: View {
            ...
            List {
                ...
                Section {
                    Toggle(isOn: Binding(
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text(NSLocalizedString(
                                "settings.appearance.glass_effects.detail",
                                comment: "Use translucent backgrounds and blur"
                            ))
                            .font(.caption)
                    ...
                    Toggle(isOn: $settings.showAnimationsStorage) {
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text(NSLocalizedString(
                                "settings.appearance.animations.detail",
                                comment: "Enable smooth transitions and effects"
                            ))
                            .font(.caption)
                            .foregroundColor(.secondary)
                        }
                ...
                Section {
                    ...
                    Toggle(isOn: Binding(
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text(NSLocalizedString(
                                "settings.appearance.accent.custom.toggle",
                                value: "Enable custom accent color",
                                comment: "Enable custom accent color"
                            ))
                            Text(NSLocalizedString(
                                "settings.appearance.accent.custom.detail",
                                value: "Overrides the built-in palette.",
                                comment: "Custom accent color detail"
                            ))
                            .font(.caption)
                            .foregroundColor(.secondary)
                        }
                    ...
                    ColorPicker(
                        NSLocalizedString(
                            "settings.appearance.accent.custom.picker",
                            value: "Custom accent tint",
                            comment: "Custom accent tint"
                        ),
                        selection: Binding(
                    ...
                    Text(NSLocalizedString(
                        "settings.appearance.accent.header",
                        value: "Accent",
                        comment: "Accent section header"
                    ))
                }
            }
        ...
        private func styleLabel(_ style: InterfaceStyle) -> String {
            switch style {
            case .system:
                NSLocalizedString("settings.appearance.theme.system", comment: "System")
            case .light:
                NSLocalizedString("settings.appearance.theme.light", comment: "Light")
            case .dark:
                NSLocalizedString("settings.appearance.theme.dark", comment: "Dark")
            case .auto:
                NSLocalizedString("settings.appearance.theme.auto", comment: "Auto")
            }
        }
    }
