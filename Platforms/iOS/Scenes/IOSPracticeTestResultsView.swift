...
struct IOSPracticeTestResultsView: View {
    ...
    private var scoreInterpretation: String {
        ...
        case 0.8..<0.9:
            return "Great work! You have a strong understanding."
        case 0.7..<0.8:
            return "Good job! A few more topics to review."
        case 0.6..<0.7:
            return "Fair. Consider reviewing the material again."
        default:
            return "Needs improvement. Review the explanations below."
        }
    }
    ...
    private func answerChoiceReview(letter: String, text: String, isCorrect: Bool, isUserAnswer: Bool) -> some View {
