    ...
    struct IOSSubscriptionView: View {
            ...
            NavigationStack {
                ...
                .alert("Restored", isPresented: $showRestoreSuccess) {
                    ...
                    Text(NSLocalizedString(
                        "iossubscription.your.purchases.have.been.restored",
        ...
        private var headerSection: some View {
            VStack(spacing: 16) {
                ...
                Text(NSLocalizedString(
                    "iossubscription.unlock.premium",
                ...
                Text(NSLocalizedString(
                    "iossubscription.get.unlimited.access.to.all.features",
                    value: "Get unlimited access to all features",
                    comment: "Get unlimited access to all features"
                ))
                .font(.subheadline)
                ...
                VStack(spacing: 8) {
                    HStack {
                        Image(systemName: "checkmark.circle.fill")
                            ...
                            .accessibilityHidden(true)
                        Text(NSLocalizedString(
                            "iossubscription.active.subscription",
            ...
            case .expired:
                HStack {
                    Image(systemName: "exclamationmark.circle.fill")
                        ...
                        .accessibilityHidden(true)
                    Text(NSLocalizedString(
                        "iossubscription.subscription.expired",
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                PricingRow(
                    title: NSLocalizedString(
                        "iossubscription.pricing.monthly",
                        value: "Monthly",
                        comment: "Monthly plan title"
                    ),
                    price: "$5.99",
                    detail: NSLocalizedString(
                        "iossubscription.pricing.monthly.detail",
                        value: "per month",
                ...
                PricingRow(
                    title: NSLocalizedString(
                        "iossubscription.pricing.semester",
                        value: "Semester",
                        comment: "Semester plan title"
                    ),
                    price: "$25",
                    detail: NSLocalizedString(
                        "iossubscription.pricing.semester.detail",
                ...
                PricingRow(
                    title: NSLocalizedString(
                        "iossubscription.pricing.yearly",
                        value: "Yearly",
                        comment: "Yearly plan title"
                    ),
                    price: "$40",
                    detail: NSLocalizedString(
                        "iossubscription.pricing.yearly.detail",
                        value: "per year",
                ...
                PricingRow(
                    title: NSLocalizedString(
                        "iossubscription.pricing.lifetime",
                        value: "Lifetime",
                        comment: "Lifetime plan title"
                    ),
                    price: "$199",
                    detail: NSLocalizedString(
                        "iossubscription.pricing.lifetime.detail",
                        value: "one-time",
                ...
                Text(NSLocalizedString(
                    "iossubscription.pricing.includes",
        ...
        private var loadingPlaceholder: some View {
            VStack(spacing: 12) {
                ProgressView()
                Text(NSLocalizedString(
                    "iossubscription.loading.subscription.options",
        ...
        private var featuresSection: some View {
            VStack(alignment: .leading, spacing: 16) {
                Text(NSLocalizedString(
                    "iossubscription.premium.features",
                ...
                FeatureRow(
                    ...
                    description: "Intelligent scheduling optimized for your learning"
                )
                FeatureRow(
                ...
                FeatureRow(
                    ...
                    description: "Store all your assignments and study materials"
                )
                FeatureRow(
        ...
        private var restoreButton: some View {
            Button {
                ...
                Text(NSLocalizedString(
                    "iossubscription.restore.purchases",
