            ...
            NavigationStack {
                ...
                .alert("Delete Session?", isPresented: $showDeleteConfirm) {
                    ...
                    Text(NSLocalizedString(
                        "recentsessions.this.cant.be.undone",
                        value: "This can't be undone.",
                        comment: "This can't be undone."
                    ))
                }
            }
        }
                    ...
                    if selectedActivityFilter != nil || selectedDateRange != .all {
                        Section {
                            Button(NSLocalizedString(
                                "recentsessions.button.clear.filters",
                                value: "Clear Filters",
                    ...
                    HStack(alignment: .top, spacing: 12) {
                        ...
                        Menu {
                            Button {
                                ...
                                Label(
                                    NSLocalizedString("recentsessions.label.edit", value: "Edit", comment: "Edit"),
                                    systemImage: "pencil"
                                )
                            }
