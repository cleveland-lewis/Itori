    ...
    final class IOSSheetRouter: ObservableObject {
        ...
        enum SheetKind: Identifiable {
            ...
            var id: UUID {
                switch self {
                case let .addAssignment(defaults): defaults.id
                case let .addCourse(defaults): defaults.id
                case let .addGrade(id): id
                }
            }
        }
    ...
    final class IOSFilterState: ObservableObject {
        ...
        private static let semesterKey = "itori.ios.filters.semester"
        private static let courseKey = "itori.ios.filters.course"
    }
#endif
