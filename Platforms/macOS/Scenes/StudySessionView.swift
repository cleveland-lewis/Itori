    ...
    struct StudySessionView: View {
            ...
            VStack(spacing: 24) {
                ...
                HStack(spacing: 12) {
                    ...
                    Button(NSLocalizedString(
                        "studysession.button.study.again",
                        value: "Study Again",
                        comment: "Study Again"
                    )) {
                        startSession()
        ...
        private var emptyView: some View {
            VStack(spacing: 16) {
                ...
                Text(NSLocalizedString(
                    "studysession.no.cards.to.study",
                ...
                Text(NSLocalizedString(
                    "studysession.all.cards.are.up.to.date",
                    value: "All cards are up to date!",
                    comment: "All cards are up to date!"
                ))
                .font(.subheadline)
                .foregroundStyle(.secondary)
