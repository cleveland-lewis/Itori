    ...
    class MenuBarManager {
        ...
        init(focusManager _: FocusManager, assignmentsStore: AssignmentsStore, settings: AppSettingsModel) {
            ...
            NotificationCenter.default
                .addObserver(forName: .timerStateDidChange, object: nil, queue: .main) { [weak self] notification in
        ...
        private func shouldUpdateMenuContent(mode _: LocalTimerMode, isRunning _: Bool) -> Bool {
            let now = Date()
