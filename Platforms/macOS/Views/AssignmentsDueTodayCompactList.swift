        ...
        var body: some View {
            VStack(alignment: .leading, spacing: 8) {
                Text(NSLocalizedString(
                    "ui.assignments.due.today",
                    value: "Assignments Due Today",
                    comment: "Assignments Due Today"
                ))
                .font(.headline)

                if todayTasks.isEmpty {
                    Text(NSLocalizedString(
                        "ui.no.assignments.due.today",
                        value: "No assignments due today.",
                        comment: "No assignments due today."
                    ))
                    .font(.subheadline)
                    ...
                    VStack(spacing: 6) {
                        ForEach(todayTasks, id: \.id) { task in
                            ...
                            .padding(8)
                            .background(
                                DesignSystem.Materials.surface,
