        ...
        var body: some View {
            Form {
                ...
                Section {
                    Toggle(
                        NSLocalizedString(
                            "settings.toggle.enable.study.coach",
                            value: "Enable Study Coach",
                            comment: "Enable Study Coach"
                        ),
                        isOn: $settings.enableStudyCoach
                    )
                    ...
                    Toggle(
                        NSLocalizedString(
                            "settings.toggle.smart.notifications",
                            value: "Smart Notifications",
                            comment: "Smart Notifications"
                        ),
                        isOn: $settings.smartNotifications
                    )
                    ...
                    Text(NSLocalizedString(
                        "settings.the.study.coach.helps.you",
                        value: "The Study Coach helps you maintain focus and suggests optimal study patterns based on your energy levels.",
                        comment: "The Study Coach helps you maintain focus and sugge..."
                    ))
                    .font(DesignSystem.Typography.caption)
                    .foregroundStyle(.secondary)
                }
                ...
                Section {
                    Toggle(
                        NSLocalizedString(
                            "settings.toggle.track.study.hours",
                            value: "Track Study Hours",
                            comment: "Track Study Hours"
                        ),
                        isOn: $settings.trackStudyHours
                    )
                    ...
                    Toggle(
                        NSLocalizedString(
                            "settings.toggle.show.productivity.insights",
                            value: "Show Productivity Insights",
                            comment: "Show Productivity Insights"
                        ),
                        isOn: $settings.showProductivityInsights
                    )
                    ...
                    Text(NSLocalizedString(
                        "settings.productivity.tracking",
                        value: "Productivity Tracking",
                        comment: "Productivity Tracking"
                    ))
                }
                ...
                Section {
                    VStack(alignment: .leading, spacing: 12) {
                        Text(NSLocalizedString(
                            "settings.cognitive.preferences",
                            value: "Cognitive Preferences",
                            comment: "Cognitive Preferences"
                        ))
                        .font(.subheadline.weight(.semibold))

                        Toggle(
                            NSLocalizedString(
                                "settings.toggle.prefer.morning.study.sessions",
                                value: "Prefer Morning Study Sessions",
                                comment: "Prefer Morning Study Sessions"
                            ),
                            isOn: $settings.preferMorningSessions
                        )
                        ...
                        Toggle(
                            NSLocalizedString(
                                "settings.toggle.prefer.evening.study.sessions",
                                value: "Prefer Evening Study Sessions",
                                comment: "Prefer Evening Study Sessions"
                            ),
                            isOn: $settings.preferEveningSessions
                        )
                        ...
                        Toggle(
                            NSLocalizedString(
                                "settings.toggle.enable.deep.work.mode",
                                value: "Enable Deep Work Mode",
                                comment: "Enable Deep Work Mode"
                            ),
                            isOn: $settings.enableDeepWorkMode
                        )
                    ...
                    Text(NSLocalizedString(
                        "settings.customize.your.study.preferences.based",
                        value: "Customize your study preferences based on your peak productivity times.",
                        comment: "Customize your study preferences based on your pea..."
                    ))
                    .font(DesignSystem.Typography.caption)
                    .foregroundStyle(.secondary)
                }
