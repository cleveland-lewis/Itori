        ...
        var body: some View {
            VStack(alignment: .leading, spacing: 12) {
                HStack {
                    ...
                    Button(action: onAdd) {
                        Label(
                            NSLocalizedString("activitylist.label.new", value: "New", comment: "New"),
                            systemImage: "plus"
                        )
                    }
                ...
                Button {
                    ...
                    Label(
                        NSLocalizedString(
                            "activitylist.label.add.collection",
                ...
                Text(name)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: DesignSystem.Layout.cornerRadiusStandard, style: .continuous)
                            .stroke(
                                selected ? Color.accentColor.opacity(0.6) : .separatorColor.opacity(0.08),
                                lineWidth: 1
                            )
                    )
