    ...
    struct ActivityEditorView: View {
        ...
        init(
            ...
            onSave: @escaping (TimerActivity) -> Void,
                ...
                Form {
                    Section(header: Text(NSLocalizedString(
                        ...
                        Picker(
                            "Study Category",
                            selection: Binding(
                                get: { selectedCategory ?? StudyCategory.reading },
                    ...
                    Section(header: Text(NSLocalizedString("activityeditor.links", value: "Links", comment: "Links"))) {
                        Picker("Course", selection: Binding(
                            ...
                            Text(NSLocalizedString("activityeditor.none", value: "None", comment: "None"))
                                .tag(UUID?.none)
                        ...
                        Picker(
                            "Assignment",
                            selection: Binding(get: { selectedAssignmentID }, set: { selectedAssignmentID = $0 })
                        ) {
                            Text(NSLocalizedString("activityeditor.none", value: "None", comment: "None"))
                                .tag(UUID?.none)
                        ...
                        Picker(
                            "Collection",
                            selection: Binding(get: { selectedCollectionID }, set: { selectedCollectionID = $0 })
                        ) {
                            Text(NSLocalizedString("activityeditor.none", value: "None", comment: "None"))
                                .tag(UUID?.none)
