        ...
        var body: some View {
            Form {
                Section {
                        ...
                        HStack {
                            ...
                            VStack(spacing: 12) {
                                ...
                                Text(NSLocalizedString(
                                    "settings.no.semesters.defined",
                                    value: "No semesters defined",
                                    comment: "No semesters defined"
                                ))
                                .font(DesignSystem.Typography.subHeader)
                                .foregroundStyle(.secondary)
                                Button(NSLocalizedString(
                                    "settings.button.create.your.first.semester",
                                    value: "Create Your First Semester",
                                    comment: "Create Your First Semester"
                                )) {
                    ...
                    Text(NSLocalizedString(
                        "settings.manage.your.academic.semesters.the",
                        value: "Manage your academic semesters. The current semester is used for new courses and appears in the main interface.",
                        comment: "Manage your academic semesters. The current semest..."
                    ))
                    .font(DesignSystem.Typography.caption)
                    .foregroundStyle(.secondary)
                }
