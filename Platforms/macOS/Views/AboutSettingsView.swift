            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 16) {
                    ...
                    VStack(spacing: 4) {
                        ...
                        Text(NSLocalizedString(
                            "about.app.tagline",
                            value: "Academic Planning & Productivity",
                            comment: "App tagline"
                        ))
                        .font(.subheadline)
                ...
                VStack(spacing: 8) {
                    ...
                    HStack {
                        ...
                        Spacer()
                        Text(NSLocalizedString(
                            "about.build_date_value",
                            value: "January 2026",
                            comment: "Build date value"
                        ))
                        .fontWeight(.medium)
                    }
                }
                ...
                Text(NSLocalizedString(
                    "about.description",
                    value: "Itori helps students manage their academic workload with intelligent scheduling, assignment tracking, flashcard learning, and productivity tools.",
