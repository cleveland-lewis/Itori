        ...
        private var footerSection: some View {
            VStack(spacing: DesignSystem.Spacing.medium) {
                Button(action: saveSemester) {
                    Text(NSLocalizedString(
                        "semesteredit.save.semester",
                        value: "Save Semester",
                        comment: "Save Semester"
                    ))
                ...
                if let s = semesterToEdit {
                    Button(
                        NSLocalizedString("Delete Semester", value: "Delete Semester", comment: ""),
                        role: .destructive
                    ) {
                    ...
                    .confirmationDialog("Delete Semester?", isPresented: $showDeleteAlert) {
                        ...
                        Text(NSLocalizedString(
                            "semesteredit.this.will.move.the.semester",
                            value: "This will move the semester to Recently Deleted. You can recover it within 30 days.",
                            comment: "This will move the semester to Recently Deleted. Y..."
                        ))
                    }
                }
