    ...
    struct PracticeTestTakingView: View {
            ...
            HStack {
                ...
                HStack(spacing: 16) {
                    ...
                    .alert(
                        ...
                        Button(
                            NSLocalizedString("practice.taking.submit_confirm.cancel", comment: "Cancel"),
                            role: .cancel
                        ) {}
                        Button(
                            NSLocalizedString("practice.taking.submit_confirm.submit", comment: "Submit"),
                            role: .destructive
                        ) {
                            submitTest()
                        }
                        ...
                        if userAnswers.count < test.questions.count {
                            Text(String(
                                format: NSLocalizedString(
                                    "practice.taking.submit_confirm.partial",
                                    comment: "You have answered %d out of %d questions. Unanswered questions will be marked incorrect."
                                ),
                                userAnswers.count,
                            ...
                            Text(NSLocalizedString(
                                "practice.taking.submit_confirm.complete",
                                comment: "Are you sure you want to submit? You cannot change your answers after submission."
                            ))
                        }
                    }
                }
                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        HStack {
                            Text(String(
                                format: NSLocalizedString(
                                    "practice.taking.question_number",
                                    comment: "Question %d of %d"
                                ),
                    ...
                    HStack {
                        if currentQuestionIndex > 0 {
                            Button {
                                ...
                                Label(
                                    NSLocalizedString("practice.action.previous", comment: "Previous"),
                        ...
                        if currentQuestionIndex < test.questions.count - 1 {
                            Button {
                                ...
                                Label(
                                    NSLocalizedString("practice.action.next", comment: "Next"),
                    ...
                    Button {
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 12)
                                ...
                                .stroke(
                                    userAnswers[question.id] == option ? Color.blue : Color.gray.opacity(0.3),
                                    lineWidth: 2
                                )
                        )
                    }
        ...
        private func explanationInput(_ question: PracticeQuestion) -> some View {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text(NSLocalizedString(
                    "practice.taking.answer.explanation_help",
                    comment: "Provide a detailed explanation with specific examples"
                ))
                .font(.caption)
                .foregroundStyle(.secondary)
