...
//
    ...
    struct ItoriApp: App {
            ...
            var sharedModelContainer: ModelContainer = {
                ...
                do {
                    ...
                    LOG_DATA(
                        .error,
                        "ModelContainer",
                        "CRITICAL: Could not create ModelContainer: \(error.localizedDescription)"
                    )
                    ...
                    do {
                        ...
                        LOG_DATA(
                            .error,
                            "ModelContainer",
                            "CRITICAL: In-memory ModelContainer also failed: \(error.localizedDescription)"
                        )
        ...
        @ViewBuilder
        private func applyUITestOverrides(to content: some View) -> some View {
        ...
        private func sizeCategory(for raw: String) -> ContentSizeCategory? {
            ...
            switch raw {
            case "UICTContentSizeCategoryXS": .extraSmall
            case "UICTContentSizeCategoryS": .small
            case "UICTContentSizeCategoryM": .medium
            case "UICTContentSizeCategoryL": .large
            case "UICTContentSizeCategoryXL": .extraLarge
            case "UICTContentSizeCategoryXXL": .extraExtraLarge
            case "UICTContentSizeCategoryXXXL": .extraExtraExtraLarge
            case "UICTContentSizeCategoryAccessibilityM": .accessibilityMedium
            case "UICTContentSizeCategoryAccessibilityL": .accessibilityLarge
            case "UICTContentSizeCategoryAccessibilityXL": .accessibilityExtraLarge
            case "UICTContentSizeCategoryAccessibilityXXL": .accessibilityExtraExtraLarge
            case "UICTContentSizeCategoryAccessibilityXXXL": .accessibilityExtraExtraExtraLarge
            default: nil
            }
        }
