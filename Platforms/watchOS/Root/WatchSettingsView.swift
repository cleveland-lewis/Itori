            ...
            List {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        if hasActiveSession {
                            Text(NSLocalizedString(
                                "Stop timer to change mode",
                                value: "Stop timer to change mode",
                                comment: ""
                            ))
                            .font(.caption2)
                ...
                Section("Tasks") {
                    NavigationLink {
                        ...
                        Label(
                            NSLocalizedString("Task Options", value: "Task Options", comment: ""),
                ...
                Section("Planner") {
                    NavigationLink {
                        ...
                        Label(
                            NSLocalizedString("Planner Options", value: "Planner Options", comment: ""),
                ...
                Section("Sync") {
                    HStack {
                        ...
                        if syncManager.isConnected {
                            Label(
                                NSLocalizedString("Connected", value: "Connected", comment: ""),
                            ...
                            Label(
                                NSLocalizedString("Disconnected", value: "Disconnected", comment: ""),
    ...
    private struct TasksSettingsView: View {
        ...
        var body: some View {
            List {
                ...
                Section {
                    Text(NSLocalizedString(
                        "Control which tasks appear on your watch.",
                        value: "Control which tasks appear on your watch.",
                        comment: ""
                    ))
                    .font(.caption)
                    .foregroundColor(.secondary)
    ...
    private struct PlannerSettingsView: View {
        ...
        var body: some View {
            List {
                ...
                Section {
                    Text(NSLocalizedString(
                        "Control your planner view on watch.",
                        value: "Control your planner view on watch.",
                        comment: ""
                    ))
                    .font(.caption)
                    .foregroundColor(.secondary)
