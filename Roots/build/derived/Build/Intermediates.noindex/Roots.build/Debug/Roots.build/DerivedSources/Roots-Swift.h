...
#ifndef ROOTS_SWIFT_H
#define ROOTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Roots",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC5Roots24SettingsWindowController")
...
@class NSToolbar;
@class NSToolbarItem;
@interface SettingsWindowController (SWIFT_EXTENSION(Roots)) <NSToolbarDelegate>
