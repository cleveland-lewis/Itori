...
struct AssignmentPlanDependencyTests {
    @Test func linearChainSetup() async throws {
    ...
    @Test func blockedSteps() async throws {
        var plan = AssignmentPlan(assignmentId: UUID(), sequenceEnforcementEnabled: true)
    ...
    @Test func cycleDetection() async throws {
        var plan = AssignmentPlan(assignmentId: UUID(), sequenceEnforcementEnabled: true)
    ...
    @Test func topologicalSortWithCycle() async throws {
        var plan = AssignmentPlan(assignmentId: UUID(), sequenceEnforcementEnabled: true)
    ...
    @Test func sequenceEnforcementToggle() async throws {
