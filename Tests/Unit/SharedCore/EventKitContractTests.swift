...
class TestableCalendarManager {
    ...
    func createEvent(title: String, start: Date, end: Date, calendar _: FakeCalendar) async throws -> String {
        let event = FakeEvent(
            identifier: UUID().uuidString,
            title: title,
            startDate: start,
    ...
    func deletionRequiresConfirmation(eventID _: String) -> Bool {
        true // All deletions require confirmation
    }
    ...
    func hasOptimisticEvent(id: String) -> Bool {
        optimisticEvents[id] != nil
    }

    func resolveOptimisticEvent(optimisticID: String, actualID _: String) {
    ...
    func isOptimisticallyDeleted(eventID: String) -> Bool {
        optimisticDeletions.contains(eventID)
    }
    ...
    func canEdit(eventID: String) -> Bool {
        !isOptimisticallyDeleted(eventID: eventID)
    }
