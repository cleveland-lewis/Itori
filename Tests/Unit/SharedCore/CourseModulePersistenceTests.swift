...
final class CourseModulePersistenceTests: XCTestCase {
    ...
    func testFetchFilesForModule() async throws {
        ...
        _ = try await repository.addFile(courseId: courseId, nodeId: module.id, fileName: "file1.pdf", fileType: "pdf", localURL: nil)
        _ = try await repository.addFile(courseId: courseId, nodeId: module.id, fileName: "file2.pdf", fileType: "pdf", localURL: nil)
    ...
    func testFetchCourseLevelFiles() async throws {
        _ = try await repository.addFile(courseId: courseId, nodeId: nil, fileName: "syllabus.pdf", fileType: "pdf", localURL: nil, isSyllabus: true)
        _ = try await repository.addFile(courseId: courseId, nodeId: nil, fileName: "schedule.pdf", fileType: "pdf", localURL: nil)
