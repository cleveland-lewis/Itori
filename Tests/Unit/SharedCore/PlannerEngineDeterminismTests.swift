...
struct PlannerEngineDeterminismTests {
    ...
    @Test func testDeterministicSessionGeneration() async throws {
    ...
    @Test func testDeterministicScheduling() async throws {
        let dueDate = Date().addingTimeInterval(7 * 24 * 60 * 60)
        let assignment = Assignment(
            id: UUID(),
            title: "Math Final",
    ...
    @Test func testExamSessionGeneration() async throws {
        let dueDate = Date().addingTimeInterval(7 * 24 * 60 * 60)
        let assignment = Assignment(
            id: UUID(),
            title: "Physics Exam",
    ...
    @Test func testQuizSessionGeneration() async throws {
    ...
    @Test func testProjectWithCustomPlan() async throws {
    ...
    @Test func testScheduleIndexCalculation() async throws {
        let today = Date()
    ...
    @Test func testScheduleIndexConsistency() async throws {
        let today = Date()
    ...
    @Test func testSchedulingWithinTimeWindow() async throws {
        let today = Date()
    ...
    @Test func testNoOverlappingSessions() async throws {
        let today = Date()
        let dueDate = today.addingTimeInterval(7 * 24 * 60 * 60)
        
        let assignments = [
            Assignment(id: UUID(), title: "Math", courseId: nil, category: .exam, dueDate: dueDate, estimatedMinutes: 120, urgency: .high, plan: [], isLockedToDueDate: false),
            Assignment(id: UUID(), title: "Physics", courseId: nil, category: .exam, dueDate: dueDate, estimatedMinutes: 120, urgency: .high, plan: [], isLockedToDueDate: false)
        ]
    ...
    @Test func testEnergyProfileMatching() async throws {
        let today = Date()
        let dueDate = today.addingTimeInterval(7 * 24 * 60 * 60)
        let assignment = Assignment(
            id: UUID(),
        ...
        let highEnergyProfile = [9: 0.9, 10: 1.0, 11: 1.0, 12: 0.8, 13: 0.6,
                                14: 0.7, 15: 0.8, 16: 0.7, 17: 0.5, 18: 0.4,
                                19: 0.3, 20: 0.2]
    ...
    @Test func testOverflowDetection() async throws {
        let today = Date()
    ...
    @Test func testEmptySessionList() async throws {
        let settings = StudyPlanSettings()
    ...
    @Test func testSingleSession() async throws {
        let today = Date()
    ...
    @Test func testLockedToDueDate() async throws {
        let today = Date()
        let dueDate = today.addingTimeInterval(7 * 24 * 60 * 60)
        let assignment = Assignment(
            id: UUID(),
