import XCTest
    ...
    final class PlatformUnificationTests: XCTestCase {
        ...
        func testIPadOSNotActingAsMacOS() {
            if Platform.current == .iPadOS {
                XCTAssertFalse(
                    AntiPatterns.detectIPadOSAsMacOSClone(),
        ...
        func testIOSNotInheritingIPadOSComplexity() {
            if Platform.current == .iOS {
                XCTAssertFalse(
                    AntiPatterns.detectIOSInheritingIPadOSComplexity(),
        ...
        func testWatchOSNavigationDepth() {
            if Platform.current == .watchOS {
                XCTAssertFalse(
                    AntiPatterns.detectWatchOSDeepNavigation(),
        ...
        func testPlatformValidation() {
            ...
            XCTAssertTrue(
                errors.isEmpty,
                "Platform validation should pass. Errors: \(errors.map(\.description))"
            )
        }
