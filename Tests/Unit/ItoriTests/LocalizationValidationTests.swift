...
final class LocalizationValidationTests: XCTestCase {
    ...
    func testLocalizationKeysNeverReturnedAsIs() {
        ...
        for key in criticalKeys {
            ...
            XCTAssertFalse(
                LocalizationManager.isLocalizationKey(localized),
    ...
    func testKeyPatternDetection() {
        ...
        for key in validKeys {
            XCTAssertTrue(
                LocalizationManager.isLocalizationKey(key),
        ...
        for text in normalText {
            XCTAssertFalse(
                LocalizationManager.isLocalizationKey(text),
    ...
    func testTaskTypeNeverShowsRawValue() {
        ...
        for type in types {
            ...
            XCTAssertFalse(
                LocalizationManager.isLocalizationKey(name),
