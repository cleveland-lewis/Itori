...
final class LocalizationComprehensiveTests: XCTestCase {
    ...
    func testIntegerFormatting() {
        ...
        for (locale, number, expected) in testCases {
            ...
            if locale.identifier == "es_ES" {
                XCTAssertTrue(
                    normalized == expected || normalized == "1234",
    ...
    func testPercentageFormatting() {
        ...
        for (locale, number) in testCases {
            ...
            XCTAssertTrue(
                result!.contains("85") || result!.contains("٨٥"),
    ...
    func testShortDateFormatting() {
        let date = Date(timeIntervalSince1970: 1_609_459_200) // Jan 1, 2021 00:00 UTC
        ...
        for (locale, _) in testCases {
            ...
            XCTAssertTrue(
                result.contains("21") || result.contains("2021") || result.contains("01"),
    ...
    func testMediumDateFormatting() {
        ...
        for locale in locales {
            ...
            XCTAssertTrue(
                result.contains("2021") || result.contains("21"),
    ...
    func testTimeFormatting12h() {
        let date = Date(timeIntervalSince1970: 1_609_491_600) // Jan 1, 2021 09:00 UTC
        ...
        for locale in locales {
            ...
            let result = formatter.string(from: date)
            XCTAssertTrue(
                result.contains("AM") || result.contains("PM") || result.contains("am") || result.contains("pm"),
    ...
    func testTimeFormatting24h() {
        ...
        for locale in locales {
            ...
            XCTAssertTrue(
                result.contains("9") || result.contains("09"),
    ...
    func testDurationFormattingShort() {
        ...
        XCTAssertTrue(
            result.contains("m") || result.contains("min"),
    ...
    func testDurationFormattingLong() {
        ...
        XCTAssertTrue(
            result.contains("h") || result.contains("hr") || result.contains("hour"),
    ...
    func testTaskCountPluralization() {
        ...
        for (count, _) in testCases {
            ...
            if count == 0 {
                ...
                XCTAssertTrue(
                    result.lowercased().contains("task"),
    ...
    func testMinutesPluralization() {
        ...
        for count in testCases {
            ...
            if count == 1 {
                XCTAssertFalse(
                    result.lowercased().contains("minutes"),
    ...
    func testCalendarFirstWeekdayRespectLocale() {
        ...
        for locale in testLocales {
            ...
            XCTAssertTrue(
                calendar.firstWeekday >= 1 && calendar.firstWeekday <= 7,
